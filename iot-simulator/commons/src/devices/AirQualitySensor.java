...
public class AirQualitySensor extends IoTdevice {

	private static final Logger logger = LogManager.getLogger(AirQualitySensor.class);
	
	int messageSize = 50000; //in bytes

	public AirQualitySensor(String clientId, String clientName, Location location, HashSet<DataType> dataTypesProvided,
	...
	/**
	 * Method to emulate the reading of air quality.
	 * 
	 * @return String: air quality reading
	 */
	public String readAirQuality() {
		int currentAirQuality = random.nextInt(100);
		return Integer.toString(currentAirQuality);
	}
